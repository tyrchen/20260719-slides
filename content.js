...
const slides = [
  ...
  S('话题四 · 下一站：工程师的未来', '04<br><span class="accent">下一站：工程师的未来</span>', `<p class="lead">AI 不只改变编码速度，它会重新定义软件的生产单位、团队边界，以及工程师的职业杠杆。</p>${chip(['SOFTWARE','TEAM','CAREER','RESPONSIBILITY'])}`, {type:'cover', kicker:'TOPIC 04 · THE ENGINEER', visual:VISUALS.futureEngineer}),
  S('话题四 · 下一站：工程师的未来', '软件的生产单位<br>正在改变', `<div class="production-shift"><div><span>过去</span><strong>代码行 / PR</strong><p>衡量“写了多少、合了多少”。</p></div><i>→</i><div class="active"><span>未来</span><strong>已验证的能力增量</strong><p>从需求、实现、测试到运行证据的完整闭环。</p></div></div>${evidence('真正的产出','不是 Agent 生成了多少文件，而是系统获得了多少可验证、可维护、可运营的新能力。')}`, {kicker:'UNIT OF PRODUCTION'}),
  S('话题四 · 下一站：工程师的未来', '开发生命周期<br>从流水线变成反馈网', `<div class="d3-chart d3-lifecycle" data-chart="lifecycle" aria-label="AI 时代开发生命周期注意力变化"></div><p class="chart-caption">实现不再是唯一的长板；定义、验证与运行反馈会获得更多工程注意力。</p>`, {kicker:'LIFECYCLE SHIFT'}),
  S('话题四 · 下一站：工程师的未来', '团队不会消失，<br>但拓扑会改变', `<div class="team-topology"><div class="human-node"><b>Human Lead</b><span>方向 · 取舍 · 责任</span></div><div class="agent-ring"><span>Research</span><span>Spec</span><span>Build</span><span>Test</span><span>Review</span><span>Operate</span></div><div class="feedback-node"><b>Reality</b><span>用户 · 测试 · 生产</span></div></div>${evidence('组织变化','少数人可以管理更宽的工程面，但前提是角色、权限、反馈和升级路径被清楚设计。')}`, {kicker:'TEAM TOPOLOGY'}),
  S('话题四 · 下一站：工程师的未来', '哪些工作被压缩，<br>哪些能力被放大？', `<div class="d3-chart d3-value" data-chart="value" aria-label="工程能力价值矩阵"></div>`, {kicker:'VALUE MATRIX'}),
  S('话题四 · 下一站：工程师的未来', '未来工程师的<br>四层护城河', `<div class="moat-stack"><div style="--w:52%"><b>04 · 领导力与品味</b><span>决定什么值得做</span></div><div style="--w:66%"><b>03 · 验证与责任</b><span>知道怎样证明正确</span></div><div style="--w:80%"><b>02 · 系统与领域</b><span>理解约束和长期结构</span></div><div style="--w:94%"><b>01 · 工具与实现</b><span>熟练调用模型和自动化</span></div></div><p class="muted" style="margin-top:24px">工具层最容易获得，也最容易被复制；越向上，越依赖长期经验。</p>`, {kicker:'CAREER MOAT'}),
  S('话题四 · 下一站：工程师的未来', 'IC 与管理者，<br>都需要新的杠杆', `<div class="career-paths"><div><span class="eyebrow">INDIVIDUAL CONTRIBUTOR</span><h3>成为系统型 IC</h3>${list(['掌握一个真实领域','设计可执行的上下文','建立高强度验证工具','负责跨组件结果'])}</div><div><span class="eyebrow">ENGINEERING LEADER</span><h3>成为 AI 组织设计者</h3>${list(['划分人和 Agent 权限','设计任务与升级路径','管理质量、成本和风险','让团队经验持续沉淀'])}</div></div>`, {kicker:'TWO PATHS'}),
  S('话题四 · 下一站：工程师的未来', '一个可执行的<br>30 / 90 / 365 天计划', `<div class="d3-chart d3-roadmap" data-chart="roadmap" aria-label="工程师 30、90、365 天行动路线"></div>`, {kicker:'ACTION PLAN'}),
